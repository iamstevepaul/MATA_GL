...
def get_config(args=None):
    ...
    parser = argparse.ArgumentParser(
        description="Graph Neural Network based reinforcement learning solution for MRTA-Collective-Transport")
    # Environment related
    parser.add_argument('--problem', type=str, default='MRTA_Collective_Transport', help='Name of the problem')
